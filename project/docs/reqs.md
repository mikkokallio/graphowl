...
* [ ] The app automatically updates the graph data every n minutes (or has a refresh button).
...
* [X] The app has a connector for fetching XML data from REST APIs.
...
* [X] Show meaningful error messages if something is misconfigured.
